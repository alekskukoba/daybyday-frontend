      ...
      <div className="container">
        ...
        <section className="grid grid-cols-2 gap-10 mb-20">
          <p className="text-[18px] leading-8">
            ...
            sit. Aliquet justo adipiscing pulvinar lorem integer tortor cras
            eget integer.
          </p>
          <p className="text-[18px] leading-8">
            ...
            Cursus tortor enim pellentesque porttitor. Proin condimentum
            dictumst ullamcorper donec a vitae blandit non non.
          </p>
        </section>
